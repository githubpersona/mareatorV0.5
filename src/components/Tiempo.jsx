...
const Tiempo = (props) => {
  ...
  var num = 6;
  for (var i = 0; i < num; i++) {
    etiquetas = etiquetas.concat(etiquetas_dia);
  }
  // const etiquetas = ['00h', '01h', '02h', '03h', '04h', '05h', '06h', '07h', '08h', '09h', '10h', '11h', '12h', '13h', '14h', '15h', '16h', '17h', '18h', '19h', '20h', '21h', '22h', '23h', '00h', '01h', '02h', '03h', '04h', '05h', '06h', '07h', '08h', '09h', '10h', '11h', '12h', '13h', '14h', '15h', '16h', '17h', '18h', '19h', '20h', '21h', '22h', '23h', '00h', '01h', '02h', '03h', '04h', '05h', '06h', '07h', '08h', '09h', '10h', '11h', '12h', '13h', '14h', '15h', '16h', '17h', '18h', '19h', '20h', '21h', '22h', '23h'];
  ...
  const recolectar_tiempo = () => {
    ...
    fetch(props.url)
      ...
      .then((data) => {
          ...
          .then((data) => {
            ...
            fetch(props.url2)
              ...
              .then((data) => {
                ...
                // datos_openmeteo.colores_columnas = colores_columnas;

                // console.log(datos_openmeteo);
        ...
        // datos_aemet.time = datos_aemet.time.map(v => v.slice(11, 13) + "h");

        // datos_aemet.colores_cielo = datos_aemet.cloudcover.map(cielo => cielo_colores[Math.ceil(cielo / 25) - 1]);
        // datos_aemet.colores_columnas = colores_columnas;

        // let temperatura = datos_aemet.temperature_2m[horas_hoy];
        // let precipitacion = datos_aemet.precipitation_probability[horas_hoy];
        // let cielo = datos_aemet.cloudcover[horas_hoy];
        // let lluvia = datos_aemet.rain[horas_hoy];
      ...
      new Chart(ctx, {
        data: {
          ...
          datasets: [
            ...
            // {
            //     type: 'bar',
            //     data: Array(datos_aemet.time.slice(horas_hoy, 73).length).fill(5),
            //     yAxisID: 'y_dianoche',
            //     backgroundColor: datos_aemet.colores_columnas.slice(horas_hoy, 73),
            //     barPercentage: 1,
            //     categoryPercentage: 1,
            // },
          ],
